...
const ws = require('ws');
const { connect: redisConnect, getRedisClient } = require('./redis.js');
const { cacheHostUrl } = require('./constants.js');
  ...
  const _req = protocol => (req, res) => {
    try {
      ...
      if (o.host === 'login.exokit.org') {
        ...
        handleAccounts("mainnetsidechain")(req, res);
        return;
      } else if (o.host === 'testnetsidechain-accounts.webaverse.com') {
        handleAccounts("testnetsidechain")(req, res);
        return;
