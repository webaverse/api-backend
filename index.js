...
const {GITHUB_CLIENT_ID, GITHUB_CLIENT_SECRET, DISCORD_CLIENT_ID, DISCORD_CLIENT_SECRET, CACHE_HOST_URL, HTTP_PORT, HTTPS_PORT} = require('./config.js');
